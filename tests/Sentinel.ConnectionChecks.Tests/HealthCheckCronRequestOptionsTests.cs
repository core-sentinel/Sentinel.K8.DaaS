...
public class HealthCheckCronRequestOptionsTests
{
    ...
    public void Should_Deserialize_HealthCheckCronRequest_From_AppSettings_Using_Options_Pattern()
    {
        ...
        Assert.True(healthCheckConfig.TcpPing.ContainsKey("api-check"));
        var tcpCheck = healthCheckConfig.TcpPing["api-check"];
        ...
        var httpCheck = healthCheckConfig.Http["health-check"];
        ...
        var storageCheck = healthCheckConfig.StrorageAccount["prod-storage"];
        ...
        var kvCheck = healthCheckConfig.KeyVault["app-keyvault"];
        ...
        var sbCheck = healthCheckConfig.ServiceBus["orders-queue"];
        ...
        var redisCheck = healthCheckConfig.Redis["cache-check"];
        ...
        var ehCheck = healthCheckConfig.EventHub["telemetry-hub"];
        ...
        var cosmosCheck = healthCheckConfig.CosmosDB["main-db"];
        ...
        var sqlCheck = healthCheckConfig.SQLServer["prod-sql"];
        ...
        var appConfigCheck = healthCheckConfig.AzureAppConfig["app-config"];
    ...
    public void Should_Deserialize_HealthCheckCronRequest_With_ServicePrincipal_Authentication()
    {
        ...
        var kvCheck = healthCheckConfig.KeyVault["prod-keyvault"];
    ...
    public void Should_Deserialize_HealthCheckCronRequest_With_ConnectionStrings()
    {
        ...
        var sbCheck = healthCheckConfig.ServiceBus["legacy-queue"];
        ...
        var redisCheck = healthCheckConfig.Redis["legacy-cache"];
        ...
        var cosmosCheck = healthCheckConfig.CosmosDB["legacy-cosmos"];
        ...
        var sqlCheck = healthCheckConfig.SQLServer["legacy-sql"];
