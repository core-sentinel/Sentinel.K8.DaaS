...
//        TestNetConnectionResponse additionalResult = null;
//        request.RedisDetails.UseMSI = request.UseMSI;
//        request.RedisDetails.ServicePrincipal = request.ServicePrincipal;

//        IBasicCheckAccessRequest details = request.RedisDetails;

//        var qq = await _mediator.Send(details);
